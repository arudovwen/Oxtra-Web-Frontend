        ...
        <div className='flex gap-y-8 lg:gap-y-0 md:gap-x-8  flex-col md:flex-row'>
          <div className='w-full md:max-w-[300px] lg:max-w-[320px] xl:mr-[3rem]'>
            ...
            <div className='text-brandGray-100 text-sm font-gordita-regular leading-normal mb-[16px]'>
              We are a technology-driven company dedicated to advancing sustainability
              e-transportation solutions in Africa.
            </div>
          ...
          <div className='flex-1 grid grid-cols-2 lg:grid-cols-4 gap-y-6 lg:gap-y-0 lg:gap-x-10'>
            <div>
              <div className={headingClasses}>
                <Typography as='h6' font='font-gordita-bold' className='!text-sm'>
                  Company
                </Typography>
              </div>
              <ul>
            ...
            <div>
              ...
              <Typography as='h6' font='font-gordita-bold' className='!text-sm mb-[16px]'>
                Social media
              </Typography>
