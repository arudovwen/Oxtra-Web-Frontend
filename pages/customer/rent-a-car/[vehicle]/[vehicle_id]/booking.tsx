...
import TripDetails from "@/components/data/customer/rent-a-car/booking/TripDetails";
import Breakdown from "@/components/data/customer/rent-a-car/booking/Breakdown";
...
const Bookings = () => {
  ...
  const { vehicle, vehicle_id } = router.query;

  // @ts-ignore
  const { data, isLoading, refetch } = useGetNonUserVehicle(vehicle_id, {
