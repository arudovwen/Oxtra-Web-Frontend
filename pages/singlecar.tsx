...
const blockClasses = classNames(`border   border-[#d4d6d8] p-5 rounded-lg mb-[24px]`);

const tripClasses = classNames(
  `text-[12px] font-gordita-regular leading-[12px] text-brandGray-300`
);

const inputClasses = classNames('px-2 py-2 border border-[#d4d6d8] rounded-lg mt-3  w-full');

const labelClasses = classNames('font-gordita-medium text-brandGray-100 text-sm');
        ...
        <div className='flex gap-[40px] mb-[31px]'>
          <div className={`${blockClasses}, w-1/2 h-full`}>
            <div className='flex gap-[40px]'>
              <Image src={car} height={261} width={192} alt='car' className='rounded-lg' />
              <div>
                <div className='mb-6'>
          ...
          <form className='w-1/2' onSubmit={handleSubmit}>
            <div className={blockClasses}>
              ...
              <div className='bg-brandGray-200 text-brandGray-300 p-6 rounded-lg mb-[20px]'>
                <h2 className='text-[24px] mb-4 leading-[24px] font-gordita-medium '>Your offer</h2>{' '}
                <ul>
                  {offers.map((offer) => {
                    return (
                      <li
