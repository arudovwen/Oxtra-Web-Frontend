  ...
  return (
    <div className='mb-[71px]'>
      <Flex flexDir='column' justifyContent='center' align='center'>
        ...
        <Box px={{ base: '10px', md: 'unset' }} mt='40px' w={{ base: '100%', md: '30%' }}>
                ...
                <Box bg='#F4F4F4' borderRadius='8px' mb='23px' p='16px'>
                  ...
                  {i === 1 && show?.wallet ? (
                    ...
                    >
                      ...
                      <Text fontSize='32px' color='#242424' fontWeight={700} my='16px'>
                        ₦5,000
                      </Text>
                    ...
                    >
                      ...
                      <Flex align='center' justifyContent='space-between' w='full'>
                        <Text color='#242424' fontSize='32px' fontWeight={700} my='16px'>
                          0948300045
                        </Text>
                    ...
                    show?.card && (
                      <Box textAlign='start' mt='18px'>
                        <Box>
                          <Text fontSize='12px' color='#344054' fontWeight={500}>
                            Card Number
                          </Text>
                          <InputGroup>
                            <InputLeftElement display={card?.number ? 'flex' : 'none'} h='44px'>
                              <Flex
                                ...
                                align='center'
                              >
                                <Image w='23px' h='14px' objectFit='contain' src={cardLogo} />
                              </Flex>
                            </InputLeftElement>
                            <Input
                              bg='#fff'
