...
const inputClasses = classNames('px-2 py-2 border rounded border-[#d4d6d8] mt-3  w-full h-[40px]');

const labelClasses = classNames('font-gordita-medium text-brandGray-300 text-xs lg:text-sm');
    ...
    <form className='flex items-center flex-col lg:flex-row gap-[20px]'>
      <div className='flex-1 flex flex-col lg:flex-row gap-y-5 lg:gap-y-0 lg:gap-x-5 w-full lg:w-auto'>
        <div className='flex-1'>
          ...
          <input type='text' placeholder='Enter address or airport' className={inputClasses} />
        </div>
        <div className='flex-1'>
