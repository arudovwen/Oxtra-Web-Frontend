...
export const offers = [
  ...
  {
    title: 'Our Values',
    description: 'Sustainability, Innovation, Customer-centricity, Inclusivity, and Transparency',
    image: values,
  },
];
...
export const sortings = ['Most popular rentals', 'Top rated rentals', 'Low cose rentals'];
