      ...
      <Container>
        ...
        <div className='text-white text-center xl:text-left pb-[204px] mt-[110px]'>
          ...
          <div className='xl:max-w-[648px] md:text-[20px] leading-[30px] font-gordita-light'>
            Experience effortless vehicle rental! Find and book your perfect ride with ease. Our
            flexible options ensure you get the ideal vehicle for any journey. Explore our wide
            range of vehicles today!
          </div>
        </div>
      </Container>
