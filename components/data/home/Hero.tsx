    ...
    <div className='relative isolate overflow-hidden'>
      ...
      <Container>
        ...
        <div className='text-white text-center xl:text-left pb-[204px] mt-[110px]'>
          ...
          <div className='xl:max-w-[648px] text-[20px] leading-[30px] font-gordita-light'>
            With our flexible options, you can easily get a vehicle for any <br /> of your journey
            needs. Browse through our wide range of <br />
            vehicles today!
          </div>
        </div>
      </Container>
