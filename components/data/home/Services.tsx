      ...
      <Container marginBottom='mb-[120px]' className='relative pt-[350px] md:pt-[200px]'>
          ...
          {offers.map((offer) => {
            return (
              <div
                ...
                data-aos-once='true'
              >
                <span className={`mb-[26px] ${offer.iconColor}`}>{offer.icon}</span>
                <div className='mb-4'>
                  <Typography as='h6' font='font-gordita-medium' className='font-bold'>
                    {offer.title}
                  </Typography>
                </div>
        ...
        <div className='text-center mt-[80px]'>
          <Typography as='p' font='font-gordita-medium'>
            We rely on individuals, businesses and experts to help reshape the transport sector
          </Typography>
